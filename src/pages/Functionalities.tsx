...
const Functionalities = () => {
  ...
  return (
    <>
      ...
      <Header />
      <div className="bg-[#5860ff] lg:bg-[linear-gradient(180deg,#5860ff_37.64%,#fff_203.72%)]">
        <div className="container mx-auto py-20 px-4 lg:px-10 pt-40">
          <div className="flex flex-col gap-6">
            <h1 className="text-4xl lg:text-[72px] font-bold text-[#f5f5f5]">
              Functionalities
            </h1>
            <div className="mx-auto flex w-full flex-col gap-[40px]">
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                {items.map((item, index) => (
                  <div
                    className="cursor-pointer flex text-center flex-col items-center p-6 rounded-xl bg-white/10 backdrop-blur-sm hover:bg-white/20 transition-colors"
                    key={index + 1}
                    onClick={() => {
                      setFirstModalOpen(true);
                    }}
                  >
                    <img
                      src={item.image}
                      className="mb-4 w-12 lg:w-16"
                      alt=""
                    />
                    <span className="text-base lg:text-xl text-white font-semibold">
                      {item.text}
                    </span>
                  </div>
                ))}
